...
export const VARIABLES: Record<string, ObservationVariable> = {
  ...
  flowerBudDensity: {
    id: "flowerBudDensity",
    name: "Densidad de yemas de flor (UPOV 1/3/5)",
    trait: "flower bud density",
    method: "UPOV descriptor, 1 low, 3 medium, 5 high",
    scale: "ordinal",
    categories: [
      { value: "1", rank: 1, label: "baja" },
      { value: "3", rank: 3, label: "media" },
      { value: "5", rank: 5, label: "alta" },
    ],
    levels: ["tree"],
  },
  flowerType: {
    ...
    scale: "nominal",
    categories: [
      { value: "campanulate", aliases: ["C", "campanulada"], label: "campanulada" },
      { value: "rosette", aliases: ["R", "rosácea", "rosacea"], label: "rosácea" },
    ],
    levels: ["tree"],
  },
  treeStatus: {
